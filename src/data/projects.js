...
const rawProjects = [
    ...
    },
    {
        ...
        description: ["Projeto complexo integrando chamadas de API, banco de dados e UI. Criação de comandos customizados robustos para otimizar o tempo de execução e setup de massa de dados."],
    ...
    },
    {
        ...
        description: ["Automação cross-browser configurada para paralelismo extremo usando o poder do motor do ecossistema Playwright. O projeto adota estritamente o paradigma Page Object Model (POM) garantindo manutenção isolada e clara.", "Foram desenhadas asserções dinâmicas de alta confiabilidade (auto-waiting e expect patterns), em conjunto com a interceptação de chamadas de rede mockadas garantindo previsibilidade. Toda a esteira está configurada com GitHub Actions (CI/CD)."],
    ...
    },
    {
        ...
        description: ["Projeto completo de automação mobile para testes ponta a ponta (E2E) em aplicativos Android nativos (Yodapp e MarkX).", "A arquitetura foi desenvolvida explorando duas frentes: uma com WebdriverIO (JavaScript) e outra com Robot Framework (Python). O framework lida com interações nativas complexas (swipes, taps, manipulação de UI) e integra scripts em Python para limpar e popular a base de dados no MongoDB antes das execuções, garantindo a idoneidade da massa de testes."],
    ...
    },
    {
        ...
        description: ["Atuação direta como Software Quality Engineer voluntário na ONG SouJunior. Este projeto concentra a suíte de testes E2E desenvolvida para garantir a estabilidade e confiabilidade da plataforma utilizada por profissionais de tecnologia.", "A arquitetura de qualidade contempla scripts robustos criados tanto em Cypress quanto em Playwright, cobrindo fluxos críticos de negócio como cadastro, listagem de iniciativas e depoimentos, rodando de forma contínua em pipelines de CI/CD para assegurar o conceito de 'Zero Falhas' no ambiente de impacto social."],
